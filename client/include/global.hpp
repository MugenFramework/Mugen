#ifndef MUGEN_GLOBAL_HPP
#define MUGEN_GLOBAL_HPP
...
namespace MugenNamespace
{
    ...
    namespace MugenSpace {
        ...
        struct Listener {
            ...
            static QString PayloadDoH;
            static QString PayloadTcp;
    ...
    extern MugenNamespace::MugenSpace::Mugen* MugenApplication;
};
...
namespace MugenX
{
    ...
    extern MugenNamespace::Util::ConnectionInfo     Teamserver;
    extern MugenNamespace::UserInterface::MugenUi*  MugenUserInterface;
    extern MugenNamespace::Connector*               Connector;
}
