#ifndef MUGEN_SESSIONGRAPH_HPP
#define MUGEN_SESSIONGRAPH_HPP
...
public:
    ...
    MugenNamespace::Util::SessionItem Session;
...
public:
    ...
    Node* GraphNodeAdd( MugenNamespace::Util::SessionItem Session );
    void  GraphNodeRemove( MugenNamespace::Util::SessionItem Session );
    Node* GraphNodeGet( QString AgentID );

    void  GraphPivotNodeAdd( QString AgentID, MugenNamespace::Util::SessionItem Session );
