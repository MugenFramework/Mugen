...
#ifndef MUGEN_LISTENER_HPP
#define MUGEN_LISTENER_HPP
...
class MugenNamespace::UserInterface::Dialogs::NewListener : public QDialog
{
    typedef struct {
        int         Id;
        QLineEdit*  Input;
...
public:
    ...
    QLabel*         LabelDNSBindHost;
    QComboBox*      ComboDNSBindHost;
    QLabel*         LabelDNSBindPort;
    QLineEdit*      InputDNSBindPort;
    QLabel*         LabelDNSDomain;
    QLineEdit*      InputDNSDomain;

    // Page DoH
    QWidget*        PageDoH;
    QFormLayout*    formLayout_DoH;
    QLabel*         LabelDoHBindHost;
    QComboBox*      ComboDoHBindHost;
    QLabel*         LabelDoHPortBind;
    QLineEdit*      InputDoHPortBind;
    QLabel*         LabelDoHDomain;
    QLineEdit*      InputDoHDomain;
    QLabel*         LabelDoHSecure;
    QCheckBox*      CheckDoHSecure;

    // Page TCP
    QWidget*        PageTcp;
    QFormLayout*    formLayout_Tcp;
    QLabel*         LabelTcpHost;
    QLineEdit*      InputTcpHost;
    QLabel*         LabelTcpPort;
    QLineEdit*      InputTcpPort;
