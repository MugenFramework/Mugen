...
PyTypeObject PyTreeClass_Type = {
        ...
        "Tree Widget Mugen Object",                      /* tp_doc */
        0,                                          /* tp_traverse */
        0,                                          /* tp_clear */
        0,                                          /* tp_richcompare */
        0,                                          /* tp_weaklistoffset */
...
{
    MugenX::MugenUserInterface->NewBottomTab( self->TreeWindow->window, self->title);
...
{
    MugenX::MugenUserInterface->NewSmallTab( self->TreeWindow->window, self->title);
