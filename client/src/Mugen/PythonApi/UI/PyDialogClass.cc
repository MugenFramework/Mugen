...
int DialogClass_init( PPyDialogClass self, PyObject *args, PyObject *kwds )
{
    ...
    self->DialogWindow->window = new QDialog(MugenX::MugenUserInterface->MugenWindow);
...
PyObject* DialogClass_exec( PPyDialogClass self, PyObject *args )
{
    ...
    //MugenX::MugenUserInterface->NewBottomTab( self->DialogWindow, "test");
