...
{
    MugenX::MugenUserInterface->NewBottomTab( self->WidgetWindow->window, self->title);
...
{
    MugenX::MugenUserInterface->NewSmallTab( self->WidgetWindow->window, self->title);
