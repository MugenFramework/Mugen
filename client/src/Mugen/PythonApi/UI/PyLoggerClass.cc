...
PyTypeObject PyLoggerClass_Type = {
        ...
        "Logger Widget Mugen Object",                      /* tp_doc */
        0,                                          /* tp_traverse */
        0,                                          /* tp_clear */
        0,                                          /* tp_richcompare */
        0,                                          /* tp_weaklistoffset */
...
{
    MugenX::MugenUserInterface->NewBottomTab( self->LoggerWindow->window, self->title);
...
{
    MugenX::MugenUserInterface->NewSmallTab( self->LoggerWindow->window, self->title);
