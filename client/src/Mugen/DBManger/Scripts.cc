...
bool MugenNamespace::MugenSpace::DBManager::AddScript( QString Path )
{
...
bool MugenNamespace::MugenSpace::DBManager::RemoveScript( QString Path )
{
    auto query = QSqlQuery();
    auto error = std::string();
...
bool MugenNamespace::MugenSpace::DBManager::CheckScript( QString Path )
{
    auto query = QSqlQuery();
    auto error = std::string();
...
vector<QString> MugenNamespace::MugenSpace::DBManager::GetScripts()
{
