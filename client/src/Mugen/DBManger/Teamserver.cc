...
bool MugenSpace::DBManager::addTeamserverInfo( const Util::ConnectionInfo& connection )
{
...
bool MugenSpace::DBManager::checkTeamserverExists( const QString& ProfileName )
{
    auto query   = QSqlQuery();
    auto success = false;
    auto error   = std::string();
...
bool MugenSpace::DBManager::removeTeamserverInfo( const QString& ProfileName )
{
    auto query = QSqlQuery();
    auto error = std::string();
...
vector<Util::ConnectionInfo> MugenSpace::DBManager::listTeamservers()
{
    auto query          = QSqlQuery();
...
bool MugenSpace::DBManager::removeAllTeamservers()
{
    auto query = QSqlQuery();
    auto error = std::string();
