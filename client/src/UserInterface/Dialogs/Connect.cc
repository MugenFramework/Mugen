...
void MugenNamespace::UserInterface::Dialogs::Connect::setupUi( QDialog* Form )
{
    ...
    plainTextEdit->setPlainText( "Mugen connection dialog. Connect to a Mugen teamserver." );
...
Util::ConnectionInfo MugenNamespace::UserInterface::Dialogs::Connect::StartDialog( bool FromAction )
{
    ...
    if ( this->tryConnect )
    {
        ...
        MugenX::Teamserver = *ConnectionInfo;
        MugenX::Connector  = ConnectionInstant;
        ...
        if (!FromAction) {
            ...
            MugenNamespace::MugenSpace::Mugen::Exit();
        }
...
void MugenNamespace::UserInterface::Dialogs::Connect::passDB(MugenNamespace::MugenSpace::DBManager* db)
{
    this->dbManager = db;
}

void MugenNamespace::UserInterface::Dialogs::Connect::onButton_Connect()
{
...
void MugenNamespace::UserInterface::Dialogs::Connect::itemSelected()
{
...
void MugenNamespace::UserInterface::Dialogs::Connect::onButton_NewProfile()
{
    this->isNewProfile = true;
...
void MugenNamespace::UserInterface::Dialogs::Connect::handleContextMenu( const QPoint &pos )
{
    auto globalPos = listWidget->mapToGlobal( pos );
    listContextMenu->exec( globalPos );
}

void MugenNamespace::UserInterface::Dialogs::Connect::itemRemove()
{
...
void MugenNamespace::UserInterface::Dialogs::Connect::itemsClear()
{
