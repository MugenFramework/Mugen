...
void MugenNamespace::UserInterface::SmallWidgets::EventViewer::setupUi(QWidget *Widget) {
...
void MugenNamespace::UserInterface::SmallWidgets::EventViewer::AppendText(const QString& Time, const QString& text) const {
