...
void MugenNamespace::UserInterface::Widgets::Chat::setupUi( QWidget *Form )
{
    ChatWidget = Form;
    ...
    label->setText( MugenX::Teamserver.User );
    connect( lineEdit, &QLineEdit::returnPressed, this, &Chat::AppendFromInput );

    QMetaObject::connectSlotsByName(Form);
}

void MugenNamespace::UserInterface::Widgets::Chat::AppendText(const QString& Time, const QString& text) const
{
...
void MugenNamespace::UserInterface::Widgets::Chat::AddUserMessage(const QString Time, QString User, QString text) const
{
    if ( MugenX::Teamserver.User.compare( User ) == 0 )
...
void MugenNamespace::UserInterface::Widgets::Chat::AppendFromInput()
{
    ...
    if ( ! text.isEmpty() )
    {
        ...
        auto User = MugenX::Teamserver.User.toStdString();
