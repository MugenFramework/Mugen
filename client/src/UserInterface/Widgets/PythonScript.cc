...
void MugenNamespace::UserInterface::Widgets::PythonScriptInterpreter::setupUi(QWidget *WindowWidget)
{
...
void MugenNamespace::UserInterface::Widgets::PythonScriptInterpreter::RunCode( QString code )
{
    std::string buffer;
...
void MugenNamespace::UserInterface::Widgets::PythonScriptInterpreter::AppendFromInput()
{
...
void MugenNamespace::UserInterface::Widgets::PythonScriptInterpreter::AppendOutput( QString output )
{
