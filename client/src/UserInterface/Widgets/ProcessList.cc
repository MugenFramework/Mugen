...
void MugenNamespace::UserInterface::Widgets::ProcessList::setupUi(QWidget *Widget) {
    ...
    ProcessTable->verticalHeader()->setDefaultSectionSize(28);
...
void MugenNamespace::UserInterface::Widgets::ProcessList::UpdateProcessListJson( QJsonDocument ProcessListData )
{
...
void MugenNamespace::UserInterface::Widgets::ProcessList::NewTableProcess(std::map<QString, QString> ProcessInfo) {
...
void MugenNamespace::UserInterface::Widgets::ProcessList::NewTreeProcess( std::map<QString,QString> ProcessInfo )
{
...
void MugenNamespace::UserInterface::Widgets::ProcessList::onButton_Refresh() const
{
    for ( auto & Session : MugenX::Teamserver.Sessions )
    {
        if ( Session.Name.compare( this->Session.Name ) == 0 )
        {
            ...
            {
                if ( Session.MagicValue == TenguMagicValue )
                {
...
void MugenNamespace::UserInterface::Widgets::ProcessList::onTableChange()
{
...
void MugenNamespace::UserInterface::Widgets::ProcessList::onTreeChange()
{
...
void MugenNamespace::UserInterface::Widgets::ProcessList::handleTableListMenuContext( const QPoint &pos )
{
...
void MugenNamespace::UserInterface::Widgets::ProcessList::handleTreeListMenuContext( const QPoint &pos )
{
    if ( ! ProcessTable->itemAt( pos ) )
        return;
...
void MugenNamespace::UserInterface::Widgets::ProcessList::onActionCopyPID()
{
...
void MugenNamespace::UserInterface::Widgets::ProcessList::onActionSetParentProcess()
{
