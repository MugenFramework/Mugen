...
const (
	...
	DEMON_PIVOT_TCP_LISTEN     = 20
	DEMON_PIVOT_TCP_CONNECT    = 21
	DEMON_PIVOT_TCP_DISCONNECT = 22
	DEMON_PIVOT_TCP_COMMAND    = 23
...
const (
	MUGEN_CONSOLE_MESSAGE = 0x80
	MUGEN_BOF_CALLBACK    = 0x81
)

const (
	TENGU_MAGIC_VALUE = 0x54454E47

	TENGU_SHELL    = 0x300
	TENGU_PWD      = 0x301
	TENGU_LS       = 0x302
	TENGU_CD       = 0x303
	TENGU_DOWNLOAD = 0x304
	TENGU_UPLOAD   = 0x305
	TENGU_CAT      = 0x306
	TENGU_MKDIR    = 0x307
	TENGU_RM       = 0x308
	...
	TENGU_ID       = 0x30A
	TENGU_ENV      = 0x30B
	TENGU_IFCONFIG = 0x30C
	TENGU_CHMOD    = 0x30D
	TENGU_CP       = 0x30E
	TENGU_KILL        = 0x30F
	TENGU_SOCKS5_OPEN  = 0x310
	TENGU_SOCKS5_DATA  = 0x311
	TENGU_SOCKS5_CLOSE = 0x312
	TENGU_BOF          = 0x313
	TENGU_LS_UI        = 0x314
	TENGU_PS_UI        = 0x315
	TENGU_NETSTAT      = 0x316
	TENGU_ARP          = 0x317
	TENGU_ROUTE        = 0x318
	TENGU_PERSIST_CRON = 0x319
	TENGU_PERSIST_SYS  = 0x31A
	TENGU_PERSIST_BASH = 0x31B
	TENGU_SCREENSHOT   = 0x31C
	TENGU_WHOAMI       = 0x31D
	TENGU_KEYLOG       = 0x31E
	TENGU_HARVEST      = 0x31F
	TENGU_MEMFD        = 0x320
	TENGU_PORTSCAN       = 0x321
	TENGU_PROCDUMP       = 0x322
	TENGU_RPORTFWD_OPEN  = 0x323
	TENGU_RPORTFWD_DATA  = 0x324
	TENGU_RPORTFWD_CLOSE = 0x325
	TENGU_PRIVESC        = 0x326

	TENGU_PIVOT_TCP_LISTEN  = 0x330
	TENGU_PIVOT_TCP_DATA    = 0x331
	TENGU_PIVOT_TCP_DISCONN = 0x332
)
