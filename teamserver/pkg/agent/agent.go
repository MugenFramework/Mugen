...
func (a *Agent) UpdateLastCallback(Teamserver TeamServer) {
	...
	Teamserver.AgentLastTimeCalled(a.DisplayID, a.Info.LastCallIn, a.Info.SleepDelay, a.Info.SleepJitter, a.Info.KillDate, a.Info.WorkingHours)
}
...
func (a *Agent) ToMap() map[string]interface{} {
	...
	if ParentAgent != nil {
		Info["PivotParent"] = ParentAgent.DisplayID
